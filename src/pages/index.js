  ...
  return (
    <div className="bg-indigo-50 flex flex-col items-center justify-center">
      <div className="container flex flex-col">
        <div className="flex fixed top-0 left-0 right-0 items-center pt-10 bg-gray-900 justify-center">
        ...
        <div className="flex-1 overflow-y-auto min-h-screen pt-32 10 bg-gray-900">
